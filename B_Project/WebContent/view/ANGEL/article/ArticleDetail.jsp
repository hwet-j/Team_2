...
<div class="container">
  <div class="row justify-content-center">
    <div class="col" style="margin: 20px;">
      ...
      <a href="/Angel/delete.do?articleNo=${DETAIL_CONTENT.articleNo}">
        <button type="button" class="btn btn-primary">삭제</button>
      </a>
      <a href="/Angel/article.do?pageNo=1">
        <button type="button" class="btn btn-primary">글 목록</button>
      </a>
  ...
  <div class="row justify-content-center">
    <div class="col" style="margin: 20px;">
      <p><c:forEach items="${DETAIL_COMMENT}" var="comment">
          ...
          <!-- 댓글 수정 -->
          <form action="/view/ANGEL/article/CommentModify.jsp" method="get">
            <button type="submit" class="btn btn-primary">수정</button>
            <input type="hidden" name="commentNo" value="${comment.commentNo}">
            <input type="hidden" name="name" value="${comment.name}">
          </form>
          <!-- 댓글 삭제 -->
          <form id="delete_form" action="/Angel/commentDel.do" method="post">
            <button type="button" class="btn btn-primary" onclick="comment_delete('${comment.commentNo}')">삭제</button><br><br>
